...
export class OrdersGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.radzenRentacar.getOrders(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, this.grid0.allowPaging, `Car`, null, null)
  ...
  grid0LoadData(event: any) {
    this.radzenRentacar.getOrders(`${event.filter}`, event.top, event.skip, `${event.orderby}`, event.top != null && event.skip != null, `Car`, null, null)
    .subscribe((result: any) => {
      this.getOrdersResult = result.value;
  ...
  grid0Delete(event: any) {
    this.radzenRentacar.deleteOrder(event.Id)
    .subscribe((result: any) => {
