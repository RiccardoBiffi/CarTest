...
export class EditOrderGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    ...
    this.radzenRentacar.getOrderById(this.parameters.Id)
    ...
    this.radzenRentacar.getCars(null, null, null, null, null, null, null, null)
    .subscribe((result: any) => {
  ...
  form0Submit(event: any) {
    this.radzenRentacar.updateOrder(this.parameters.Id, event)
    .subscribe((result: any) => {
      if (this.dialogRef) {
        this.dialogRef.close();
      } else {
